...
MySQL - 5.5.5-10.4.28-MariaDB : Database - buensabor_cortez
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`buensabor_cortez` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;

USE `buensabor_cortez`;
...
insert  into `articulo_insumo`(`es_para_elaborar`,`precio_compra`,`stock_actual`,`stock_maximo`,`id`,`eliminado`) values ('\0',10,0,20,1,'\0'),('',12,29996,50000,2,'\0'),('',10,300,500,4,'\0'),('',15,500,7000,5,'\0'),('',5,3000,5000,6,'\0'),('',3,5000,7000,7,'\0'),('',2,4000,5000,8,'\0'),('',5,40000,50000,12,'\0'),('',4,4000,5000,13,'\0'),('',5,50000,70000,16,'\0'),('',3,7500,8000,17,'\0'),('\0',5,94,200,19,'\0'),('\0',10,91,200,20,'\0'),('',1,4000,50000,21,'\0'),('',1,4000,50000,22,'\0'),('\0',111,1,111,24,'');
...
insert  into `domicilio`(`id`,`calle`,`cp`,`numero`,`cliente_id`,`localidad_id`) values (1,'Las Palmeras',5521,3510,1,1),(2,'Avellaneda',123,123,2,12),(3,'Avellaneda',122,12,NULL,2),(4,'Avellaneda',1222,12,NULL,14);
...
insert  into `empresa`(`id`,`cuil`,`nombre`,`razon_social`) values (1,'1232424','Vanina Luna','sadsf'),(2,'123456','Mc Donalds','mac S.A');
...
insert  into `pedido`(`id`,`fecha_pedido`,`hora_estimada_finalizacion`,`total`,`total_costo`,`cliente_id`,`estado`) values (1,'2024-06-11','22:51:57.000000',18,10,1,'Cancelado'),(2,'2024-06-13','17:09:52.000000',36,27,2,'Cancelado'),(3,'2024-06-13','17:27:57.000000',36,27,2,'Recibido'),(4,'2024-06-13','18:55:46.000000',63,55,2,'Recibido'),(5,'2024-06-13','18:55:13.000000',22.5,15,2,'Recibido'),(6,'2024-06-13','20:14:24.000000',10,5,2,'Recibido'),(7,'2024-06-13','20:17:21.000000',10,5,2,'Listo'),(8,'2024-06-18','11:21:28.000000',35,22,2,'Listo'),(9,'2024-06-18','11:40:33.000000',58.5,37,2,'En camino'),(10,'2024-06-18','11:57:14.000000',18,12,2,'En camino'),(11,'2024-06-18','11:57:16.000000',18,12,2,'Entregado'),(12,'2024-06-18','11:44:21.000000',18,12,2,'Entregado'),(13,'2024-06-18','11:44:46.000000',18,12,2,'Recibido'),(14,'2024-06-18','11:47:01.000000',18,12,2,'Recibido'),(15,'2024-06-18','11:53:09.000000',18,12,2,'Recibido'),(16,'2024-06-18','11:57:45.000000',18,12,2,'Recibido'),(17,'2024-06-18','12:07:45.000000',18,12,2,'Recibido'),(18,'2024-06-18','12:11:31.000000',18,12,2,'Recibido'),(19,'2024-06-18','12:12:37.000000',18,12,2,'Recibido'),(20,'2024-06-18','12:17:26.000000',18,12,2,'Recibido'),(21,'2024-06-18','12:13:10.000000',27,15,2,'Recibido'),(22,'2024-06-18','12:13:26.000000',22.5,15,2,'Recibido'),(23,'2024-06-18','12:20:13.000000',18,12,2,'Cancelado'),(24,'2024-06-18','13:16:42.000000',27,40,2,'Cancelado'),(25,'2024-06-18','20:42:03.000000',49.5,77,2,'Recibido'),(26,'2024-06-18','21:27:15.000000',112.5,65,2,'Recibido'),(27,'2024-06-18','20:58:50.000000',27,40,2,'Recibido'),(28,'2024-06-21','13:00:15.000000',18,12,2,'Aprobado'),(29,'2024-06-21','13:16:50.000000',54,12,2,'Recibido'),(30,'2024-06-21','13:02:38.000000',13.5,10,2,'Recibido');
...
insert  into `sucursal`(`id`,`casa_matriz`,`horario_apertura`,`horario_cierre`,`nombre`,`domicilio_id`,`empresa_id`) values (1,'','07:00:00.000000','21:00:00.000000','vanina',3,NULL),(2,'','07:00:00.000000','21:00:00.000000','Mc Donalds Las heras',4,NULL);

/*Table structure for table `sucursal_categoria` */
...
CREATE TABLE `sucursal_categoria` (
  ...
  CONSTRAINT `FKgr9g4037djhuxuahxtttbcpe6` FOREIGN KEY (`sucursal_id`) REFERENCES `sucursal` (`id`),
  CONSTRAINT `FKtcbmv4283gg4r2ds9v510up26` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

/*Data for the table `sucursal_categoria` */

insert  into `sucursal_categoria`(`sucursal_id`,`categoria_id`) values (1,1),(1,2),(1,3),(1,4),(2,1);
...
insert  into `unidad_medida`(`id`,`denominacion`,`eliminado`) values (1,'Litros','\0'),(2,'Kilos','\0'),(3,'Unidad','\0'),(4,'pruebaeliminar',''),(5,'mililitros','\0'),(6,'cm',''),(7,'gr',''),(8,'centilitros',''),(9,'metros',''),(10,'horas',''),(11,'minutos',''),(12,'segundos',''),(13,'Gramos','\0'),(14,'aaaaa',''),(15,'dddd','');
